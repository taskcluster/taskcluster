...
suite(testing.suiteName(), function () {
    ...
    test(name, async function () {
      ...
      if (input.authorization) {
        ...
        if (typeof input.authorization.ext === 'object') {
          input.authorization.ext = Buffer.from(JSON.stringify(input.authorization.ext)).toString('base64');
        }

        // create the authorization "header"
        const url = `https://${input.host}${input.resource}`;
        input.authorization = hawk.client.header(url, input.method, input.authorization).header;
      }
      ...
      if (input.bewit) {
        ...
        if (typeof input.bewit.ext === 'object') {
          input.bewit.ext = Buffer.from(JSON.stringify(input.bewit.ext)).toString('base64');
        }
  ...
  const testWithTemp = function (name, options, inputFn, expected) {
    ...
    const makeInput = () => {
      ...
      if (options.signature) {
        cert.signature = crypto.createHmac('sha256', options.signature).digest('base64');
      } else {
  ...
  makeTest(
    'simple credentials with payload hash',
    {
      authorization: {
        credentials: { id: 'root' },
        payload: '{}',
  ...
  makeTest(
    'simple credentials, unknown field in ext (forward-compat)',
    {
      authorization: {
        credentials: { id: 'root' },
        ext: {
  ...
  makeTest(
    'invalid: non-object ext.certificate',
    {
      authorization: {
        credentials: { id: 'root' },
        ext: {
  ...
  makeTest(
    'invalid: bad ext.certificate.version',
    {
      authorization: {
        credentials: { id: 'root' },
        ext: {
  ...
  makeTest(
    'invalid: authorized scopes not satisfied by clientId',
    {
      authorization: {
  ...
  makeTest(
    'invalid: authorizedScopes not an array',
    {
      authorization: {
        credentials: { id: 'unpriv' },
        ext: {
  ...
  makeTest(
    'invalid: authorizedScopes invalid scope',
    {
      authorization: {
        credentials: { id: 'unpriv' },
        ext: {
  ...
  testWithTemp(
    'basic temporary credentials where the issuer does not have an explicit assume:anonymous',
    {
      id: 'unpriv',
      scopes: ['scope2'],
    },
  ...
  testWithTemp(
    'invalid: expired temporary credentials',
    {
  ...
  testWithTemp(
    'temporary credentials that expire soon give correct expiration',
    {
      expiry: one_hour,
      id: 'root',
      scopes: ['tmpscope'],
  ...
  testWithTemp(
    'temporary credentials that expire after issuer give correct expiration',
    {
      expiry: three_hours,
      id: 'root',
      scopes: ['tmpscope'],
  ...
  testWithTemp(
    'invalid: postdated temporary credentials',
    {
  ...
  testWithTemp(
    'invalid: year-long temporary credentials',
    {
  ...
  testWithTemp(
    'invalid: bad signature for temp creds',
    {
      id: 'root',
  ...
  testWithTemp(
    ...
    failed(
      "ext.certificate issuer `unpriv` doesn't satisfy all certificate " +
        'scopes godlike.  The temporary credentials were not generated correctly.',
    ),
  );

  testWithTemp(
    'temporary credentials with authorizedScopes',
    {
      id: 'root',
  ...
  testWithTemp(
    'temporary credentials with authorizedScopes (that need expansion)',
    {
      id: 'root',
  ...
  testWithTemp(
    'invalid: temporary credentials with authorizedScopes not satisfied',
    {
      id: 'unpriv',
      scopes: ['scope2'],
    },
  ...
  testWithTemp(
    'invalid: temporary credentials with authorizedScopes, temp not satisfied',
    {
      id: 'unpriv',
      scopes: ['scope999'],
    },
    ...
    failed(
      "ext.certificate issuer `unpriv` doesn't satisfy all certificate scopes " +
  ...
  testWithTemp(
    'named temporary credentials with authorizedScopes',
    {
      id: 'my-temp-cred',
      accessToken: 'root-secret',
      scopes: ['scopes:*'],
  ...
  testWithTemp(
    'invalid: named temporary credentials with issuer == clientId',
    {
      id: 'root',
      accessToken: 'root-secret',
      scopes: ['tmpscope'],
  ...
  testWithTemp(
    'invalid: named temporary credentials clientId != name',
    {
      id: 'some-temp-cred',
      accessToken: 'root-secret',
      scopes: ['tmpscope'],
  ...
  testWithTemp(
    'invalid: named temporary credentials with issuer but no name in signature',
    {
      id: 'my-temp-cred',
      accessToken: 'root-secret',
      scopes: ['tmpscope'],
  ...
  testWithTemp(
    'invalid: named temporary credentials with name that issuer cannot create',
    {
      id: 'cant-create-this',
      accessToken: 'unpriv-secret',
      scopes: [],
    ...
    failed(
      "ext.certificate issuer `unpriv` doesn't have " + '`auth:create-client:cant-create-this` for supplied clientId.',
    ),
  );
  ...
  makeTest(
    'invalid: bewit with unknown client',
    {
      bewit: {
        id: 'somebody',
      },
  ...
  testWithTemp(
    'bewit based on temporary creds',
    {
      id: 'root',
      scopes: ['scope3'],
    },
  ...
  testWithTemp(
    'bewit based on temporary creds and authorizedScopes',
    {
      id: 'root',
      scopes: ['scope*'],
    },
  ...
  testWithTemp(
    'bewit based on named temporary creds and authorizedScopes',
    {
      id: 'root/temp-url',
      accessToken: 'root-secret',
      scopes: ['scope*'],
