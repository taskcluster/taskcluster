...
// One client connection to a subscription endpoint: the connection_init
// handshake, the keepalive and lifetime timers, subscribe/unsubscribe frames
// against the pulse engine, and the teardown of everything it owns once the
// socket closes.
export default class SubscriptionConnection {
  constructor({
    ws,
    resolveBindings,
    pulseEngine,
