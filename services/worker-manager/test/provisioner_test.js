...
helper.secrets.mockSuite(testing.suiteName(), [], function (mock, skipping) {
  ...
  suite('provisioning loop', function () {
    ...
    test('single worker pool (with running worker)', () =>
      testCase({
        workers: [
          {
            workerPoolId: 'ff/ee',
    ...
    test('single worker pool (with quarantined worker)', () =>
      testCase({
        workers: [
          {
            workerPoolId: 'ff/ee',
    ...
    test('single worker pool (with stopping worker)', () =>
      testCase({
        workers: [
          {
            workerPoolId: 'ff/ee',
    ...
    test('multiple worker pools, same provider', () =>
      testCase({
        workerPools: [
          {
            workerPoolId: 'pp/ee',
    ...
    test('multiple worker pools, different provider', () =>
      testCase({
        workerPools: [
          {
            workerPoolId: 'pp/ee',
  ...
  suite('provision', function () {
    ...
    test('provision loop is not running in parallel', async function () {
      ...
      await assert.rejects(async () => {
        await Promise.all([provisioner.provision(), provisioner.provision()]);
