#!/usr/bin/env node
var debug               = require('debug')('queue:bin:claim-reaper');
...
var launch = async function(profile) {
  ...
  var resolver = new ClaimResolver({
    ...
    publisher:        publisher,
    pollingDelay:     cfg.get('queue:claim:pollingDelay'),
    parallelism:      cfg.get('queue:claim:parallelism')
  });
