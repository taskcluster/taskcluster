...
const taskGroupRoutingKeyBuilder = function (message, _routing) {
  return {
...
exchanges.declare({
  ...
  description: ['A message published when task priority was updated via `changeTaskPriority` API call.'].join('\n'),
  routingKey: buildCommonRoutingKey(),
