...
helper.secrets.mockSuite(testing.suiteName(), [], function(mock, skipping) {
  ...
  pulseTest({
    ...
    details: {
      ...
      'event.check.url': 'https://api.github.com/repos/taskcluster/taskcluster/check-runs/6725570353',
      'event.checksuite.url': 'https://api.github.com/repos/taskcluster/taskcluster/check-suites/6781240077',
    },
    tasks_for: 'github-push',
