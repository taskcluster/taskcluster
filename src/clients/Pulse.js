...
export default class Pulse extends Client {
  ...
  overview(...args) {
    const entry = {type:'function',method:'get',route:'/overview',query:[],args:[],name:'overview',stability:'experimental',title:'Rabbit Overview',description:'Get an overview of the Rabbit cluster.',output:'http://schemas.taskcluster.net/pulse/v1/rabbit-overview.json'};
  ...
  listNamespaces(...args) {
    const entry = {type:'function',method:'get',route:'/namespaces',query:['limit','continuation'],args:[],name:'listNamespaces',stability:'experimental',title:'List Namespaces',description:'List the namespaces managed by this service.\n\nThis will list up to 1000 namespaces. If more namespaces are present a\n`continuationToken` will be returned, which can be given in the next\nrequest. For the initial request, do not provide continuation.',output:'http://schemas.taskcluster.net/pulse/v1/list-namespaces-response.json'};
  ...
  namespace(...args) {
    const entry = {type:'function',method:'get',route:'/namespace/<namespace>',query:[],args:['namespace'],name:'namespace',stability:'experimental',title:'Get a namespace',description:'Get public information about a single namespace. This is the same information\nas returned by `listNamespaces`.',output:'http://schemas.taskcluster.net/pulse/v1/namespace.json'};
  ...
  // operation.
  claimNamespace(...args) {
    const entry = {type:'function',method:'post',route:'/namespace/<namespace>',query:[],args:['namespace'],name:'claimNamespace',stability:'experimental',title:'Claim a namespace',description:'Claim a namespace, returning a username and password with access to that\nnamespace good for a short time.  Clients should call this endpoint again\nat the re-claim time given in the response, as the password will be rotated\nsoon after that time.  The namespace will expire, and any associated queues\nand exchanges will be deleted, at the given expiration time.\n\nThe `expires` and `contact` properties can be updated at any time in a reclaim\noperation.',scopes:[['pulse:namespace:<namespace>']],input:'http://schemas.taskcluster.net/pulse/v1/namespace-request.json',output:'http://schemas.taskcluster.net/pulse/v1/namespace-response.json'};
