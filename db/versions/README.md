...
| [0065](./0065.yml) | (pending release) | add `delete_indexed_task` |
| [0066](./0066.yml) | (pending release) | add get_non_stopped_workers_with_quarantine to include quarantine info from the queue |
| [0067](./0067.yml) | (pending release) | add secure storage of object hashes |
