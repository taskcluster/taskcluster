...
| [0126](./0126.yml) | (pending release) | keyset pagination variant of get_clients to avoid duplicate or skipped rows when the result set changes during a multi-page scan |
