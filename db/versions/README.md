...
| [0081](./0081.yml) | v48.0.0 | seal task group to prevent new tasks from being added to it |
| [0082](./0082.yml) | v48.2.0 | cancel multiple tasks for a given taskGroupId |
| [0083](./0083.yml) | v48.3.0 | Allow adding metadata to quarantined workers |
...
| [0087](./0087.yml) | v53.2.0 | add queue information to get_non_stopped_workers_quntil_providers |
| [0088](./0088.yml) | v54.0.0 | Include task last run state in the hooks_last_fires table |
| [0089](./0089.yml) | v55.1.0 | github checks fetching to use indexes |
| [0090](./0090.yml) | v55.3.0 | prepare queue for upcoming migration and refactoring |
| [0091](./0091.yml) | v56.0.0 | Migrate existing azure queue messages into new tables in a reversible way |
| [0092](./0092.yml) | v56.0.0 | deadline message should not be removed when task is resolved |
| [0093](./0093.yml) | v56.0.2 | Fix queue methods visibility issue, that was introduced in 91 |
| [0094](./0094.yml) | v57.1.0 | fetch pending and claimed tasks for task queue |
| [0095](./0095.yml) | v58.0.0 | Removing queue migration compat columns |
| [0096](./0096.yml) | v58.0.0 | Worker pool errors statistics |
| [0097](./0097.yml) | v59.2.0 | Worker pools extra stats |
| [0098](./0098.yml) | v64.1.0 | Add batched tasks fetching |
| [0099](./0099.yml) | v64.1.0 | Add more batched tasks fetching |
| [0100](./0100.yml) | v64.2.4 | Improves speed for batched tasks fetching |
| [0101](./0101.yml) | v65.4.0 | remove tasks from pending queue |
| [0102](./0102.yml) | v68.0.0 | update pending tasks filter to exclude expired |
| [0103](./0103.yml) | v69.0.0 | batch insert task dependencies |
| [0104](./0104.yml) | v72.0.0 | get number of claimed tasks for a task queue |
| [0105](./0105.yml) | v82.0.0 | add description here |
| [0106](./0106.yml) | v83.0.0 | insert, fetch and purge audit history for auth, hooks and secrets |
| [0107](./0107.yml) | v83.0.1 | add description here |
| [0108](./0108.yml) | v83.2.0 | missing primary keys to the tables created in version 91 |
| [0109](./0109.yml) | v83.3.0 | add worker pool launch config statistics |
| [0110](./0110.yml) | v83.5.0 | Update worker should return launch config id |
| [0111](./0111.yml) | v83.9.0 | fetch audit history for a client |
| [0112](./0112.yml) | v84.1.0 | Queue metrics |
| [0113](./0113.yml) | v87.1.1 | get correct number of claimed tasks for a task queue |
| [0114](./0114.yml) | v87.1.3 | Expired secrets and clients leaving audit trails |
| [0115](./0115.yml) | v88.1.0 | optimize w-m errors queries |
| [0116](./0116.yml) | v88.1.0 | Updating workerManager part of Launch Config should work |
| [0117](./0117.yml) | v89.0.0 | Return unique tasks from get_claimed_tasks_by_task_queue_id |
| [0118](./0118.yml) | v91.1.2 | Add primary key to tcversion table |
| [0119](./0119.yml) | v95.1.0 | Changing tasks and task groups priority |
| [0120](./0120.yml) | v96.6.0 | Get claimed tasks by worker identity |
| [0121](./0121.yml) | v96.7.0 | Add content_length to queue artifacts |
| [0122](./0122.yml) | v96.7.1 | Fix listTaskGroup pagination stability by adding ORDER BY task_id |
| [0123](./0123.yml) | v99.2.0 | Ensure uniqueness of task_id in queue_task_deadlines to keep createTask idempotent |
| [0124](./0124.yml) | v99.2.1 | Atomic queue_pending_tasks and queue_task_deadlines inserts in createTask and pending-run transitions |
| [0125](./0125.yml) | v100.1.0 | keyset pagination variant of get_non_stopped_workers_with_launch_config_scanner to avoid duplicate or skipped rows when the result set changes during a multi-page scan |
| [0126](./0126.yml) | v100.2.0 | Add a `consume_authorization_code` method |
| [0127](./0127.yml) | v102.0.0 | Remove the `else 0` fallback for priority `normal` in `queue_pending_tasks_add_for_task` |
| [0128](./0128.yml) | v102.0.0 | fix chained full outer join in queue_worker_stats that could report worker_count=0 for pools with pending but no claimed tasks |
| [0129](./0129.yml) | v109.0.0 | Add batched pending and claimed task counts for task queues |
| [0130](./0130.yml) | (pending release) | Stop returning expired indices from get_tasks_from_indexes_and_namespaces |
