...
| [0048](./0048.yml) | (pending release) | Add an index on state in the workers table |
| [0049](./0049.yml) | (pending release) | Remove unnecessary etag columns from DB tables |
| [0050](./0050.yml) | (pending release) | Use worker_pool_id instead of provisioner_id / worker_type for purge-cache |
| [0051](./0051.yml) | (pending release) | update get_non_stopped_workers db function to include all fields |
