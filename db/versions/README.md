...
| [0125](./0125.yml) | (pending release) | keyset pagination variant of get_non_stopped_workers_with_launch_config_scanner to avoid duplicate or skipped rows when the result set changes during a multi-page scan |
