...
* `get_worker_pool_error_codes(worker_pool_id_in text)` (compatibility guaranteed until v103.0.0)
* `get_worker_pool_error_launch_configs(worker_pool_id_in text, reported_since_in timestamptz)` (compatibility guaranteed until v103.0.0)
* `get_worker_pool_error_stats_last_24_hours(worker_pool_id_in text)` (compatibility guaranteed until v103.0.0)
* `get_worker_pool_error_stats_last_7_days(worker_pool_id_in text)` (compatibility guaranteed until v103.0.0)
* `get_worker_pool_error_titles(worker_pool_id_in text)` (compatibility guaranteed until v103.0.0)
* `get_worker_pool_error_worker_pools(worker_pool_id_in text)` (compatibility guaranteed until v103.0.0)
