...
suite('Repo Meta Tests', function () {
  ...
  test("no references to tools.taskcluster.net in the repository", async function () {
    ...
    const whitelist = [
      ...
      'test/meta_test.js',
      'ui/docs/reference/core/notify/usage.mdx',
      'ui/docs/reference/guide.mdx',
      'ui/docs/reference/integrations/github/intro.mdx',
      'ui/docs/reference/integrations/github/taskcluster-yml-v0.mdx',
      'ui/docs/reference/integrations/github/taskcluster-yml-v1.mdx',
      'ui/docs/reference/platform/queue/worker-hierarchy.mdx',
      'ui/docs/tutorial/apis.mdx',
      'ui/docs/tutorial/authenticate.mdx',
      'ui/docs/tutorial/create-task-via-api.mdx',
      'ui/docs/tutorial/debug-task.mdx',
      'ui/docs/tutorial/download-task-artifacts.mdx',
      'ui/docs/tutorial/finding-tasks.mdx',
      'ui/docs/tutorial/gecko-decision-task.mdx',
      'ui/docs/tutorial/gecko-tasks.mdx',
      'ui/docs/tutorial/hello-world.mdx',
      'ui/docs/tutorial/monitor-task-status.mdx',
