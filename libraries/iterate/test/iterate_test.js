...
suite(testing.suiteName(), () => {
  ...
  test(
    ...
    runWithFakeTime(async function () {
      let iterations = 0;
      ...
      i.on('stopped', () => {
        err = new Error('unexpected stopped event');
      });
  ...
  test(
    'should stop after current iteration completes',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should stop in the midst of waitTime',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should stop after correct number of iterations',
    runWithFakeTime(async function () {
      let iterations = 0;
  ...
  test(
    'should emit error when iteration watchdog expires',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit error when overall iteration limit is hit',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit iteration-failure when async handler fails',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit iteration-failure when sync handler fails',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit iteration-failure when iteration is too quick',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit error after too many failures',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit correct events for single iteration',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  test(
    'should emit correct events with maxIterations',
    runWithFakeTime(async function () {
      const i = new subject({
        name: 'foo',
        monitor,
  ...
  suite('event emission ordering', () => {
    test(
      'should be correct with maxFailures and maxIterations',
      runWithFakeTime(async function () {
        const i = new subject({
          name: 'foo',
          monitor,
    ...
    test(
      'should be correct with maxFailures only',
      runWithFakeTime(async function () {
        const i = new subject({
          name: 'foo',
          monitor,
    ...
    test(
      'should be correct when handler takes too little time',
      runWithFakeTime(async function () {
        const i = new subject({
          name: 'foo',
          monitor,
    ...
    test(
      'should be correct when handler takes too long (incremental watchdog)',
      runWithFakeTime(async function () {
        const i = new subject({
          name: 'foo',
          monitor,
    ...
    test(
      'should be correct when handler takes too long (overall time)',
      runWithFakeTime(async function () {
        const i = new subject({
          name: 'foo',
          monitor,
    ...
    test(
      'should be correct with mixed results',
      runWithFakeTime(async function () {
        let iterations = 0;
