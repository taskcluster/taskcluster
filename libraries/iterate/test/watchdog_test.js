...
suite(testing.suiteName(), function () {
  ...
  test(
    ...
    runWithFakeTime(async function () {
      ...
      await testing.sleep(1000);
      w.stop();
      assume(events).to.deeply.equal([['expired', 2998]]);
    }),
  );
});
