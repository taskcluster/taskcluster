...
type AuthClientsEntitiesRemoveDeprecatedFn = {
  (partition_key: string, row_key: string): Promise<Array<{ etag: string }>>;
  (params: { partition_key: string; row_key: string }): Promise<Array<{ etag: string }>>;
};
/** @deprecated */
...
type AuthDeleteClientFn = {
  (client_id_in: string): Promise<void>;
  (params: { client_id_in: string }): Promise<void>;
};
/** @deprecated */
type AuthExpireClientsDeprecatedFn = {
  (): Promise<[{ expire_clients: number }]>;
  (params: {}): Promise<[{ expire_clients: number }]>;
};
type AuthExpireClientsReturnClientIdsFn = {
  (): Promise<Array<{ client_id: string }>>;
  (params: {}): Promise<Array<{ client_id: string }>>;
};
/** @deprecated */
...
type AuthGetRolesFn = {
  (): Promise<
    Array<{ role_id: string; scopes: JsonB; created: Date; description: string; last_modified: Date; etag: string }>
  >;
  (params: {}): Promise<
    Array<{ role_id: string; scopes: JsonB; created: Date; description: string; last_modified: Date; etag: string }>
  >;
...
type AuthInsertAuthAuditHistoryFn = {
  (entity_id_in: string, entity_type_in: string, client_id_in: string, action_type_in: string): Promise<void>;
  (params: {
    entity_id_in: string;
    entity_type_in: string;
    client_id_in: string;
...
type AuthModifyRolesFn = {
  (roles_in: JsonB, old_etag_in: string): Promise<void>;
  (params: { roles_in: JsonB; old_etag_in: string }): Promise<void>;
};
type AuthPurgeAuditHistoryFn = {
  (cutoff_date_in: Date): Promise<void>;
  (params: { cutoff_date_in: Date }): Promise<void>;
};
/** @deprecated */
...
type GithubCreateGithubCheckFn = {
  (task_group_id_in: string, task_id_in: string, check_suite_id_in: string, check_run_id_in: string): Promise<void>;
  (params: {
    task_group_id_in: string;
    task_id_in: string;
...
type GithubDeleteGithubBuildFn = {
  (task_group_id_in: string): Promise<void>;
  (params: { task_group_id_in: string }): Promise<void>;
};
/** @deprecated */
...
type GithubGetGithubIntegrationFn = {
  (owner_in: string): Promise<Array<{ owner: string; installation_id: number }>>;
  (params: { owner_in: string }): Promise<Array<{ owner: string; installation_id: number }>>;
};
...
type GithubSetGithubBuildStateFn = {
  (task_group_id_in: string, state_in: string): Promise<void>;
  (params: { task_group_id_in: string; state_in: string }): Promise<void>;
};
/** @deprecated */
...
type GithubUpsertGithubIntegrationFn = {
  (owner_in: string, installation_id_in: number): Promise<void>;
  (params: { owner_in: string; installation_id_in: number }): Promise<void>;
};
...
type HooksDeleteHookFn = {
  (hook_group_id_in: string, hook_id_in: string): Promise<void>;
  (params: { hook_group_id_in: string; hook_id_in: string }): Promise<void>;
};
...
type HooksExpireLastFiresFn = {
  ...
  (params: {}): Promise<[{ expire_last_fires: number }]>;
};
type HooksGetHookFn = {
  (
    hook_group_id_in: string,
...
type HooksGetHookGroupsFn = {
  ...
  (params: {}): Promise<Array<{ hook_group_id: string }>>;
};
...
type HooksInsertHooksAuditHistoryFn = {
  (hook_id_in: string, client_id_in: string, action_type_in: string): Promise<void>;
  (params: { hook_id_in: string; client_id_in: string; action_type_in: string }): Promise<void>;
};
/** @deprecated */
...
type IndexDeleteIndexedTaskFn = {
  (namespace_in: string, name_in: string): Promise<void>;
  (params: { namespace_in: string; name_in: string }): Promise<void>;
};
type IndexExpireIndexNamespacesFn = {
  (): Promise<[{ expire_index_namespaces: number }]>;
  (params: {}): Promise<[{ expire_index_namespaces: number }]>;
};
type IndexExpireIndexedTasksFn = {
  (): Promise<[{ expire_indexed_tasks: number }]>;
  (params: {}): Promise<[{ expire_indexed_tasks: number }]>;
};
type IndexGetIndexNamespaceFn = {
  (parent_in: string, name_in: string): Promise<Array<{ parent: string; name: string; expires: Date }>>;
  (params: { parent_in: string; name_in: string }): Promise<Array<{ parent: string; name: string; expires: Date }>>;
};
...
type NotifyAddDenylistAddressFn = {
  (notification_type_in: string, notification_address_in: string): Promise<void>;
  (params: { notification_type_in: string; notification_address_in: string }): Promise<void>;
};
...
type NotifyDeleteDenylistAddressFn = {
  (notification_type_in: string, notification_address_in: string): Promise<[{ delete_denylist_address: number }]>;
  (params: {
...
type NotifyExistsDenylistAddressFn = {
  (notification_type_in: string, notification_address_in: string): Promise<[{ exists_denylist_address: boolean }]>;
  (params: {
    notification_type_in: string;
    notification_address_in: string;
...
type NotifyUpdateWidgetsDeprecatedFn = {
  (name_in: string): Promise<Array<{ name: string }>>;
  (params: { name_in: string }): Promise<Array<{ name: string }>>;
};
// object function signatures

type ObjectAddObjectHashesFn = {
  (name_in: string, hashes_in: JsonB): Promise<void>;
  (params: { name_in: string; hashes_in: JsonB }): Promise<void>;
};
/** @deprecated */
type ObjectCreateObjectDeprecatedFn = {
  (name_in: string, project_id_in: string, backend_id_in: string, data_in: JsonB, expires_in: Date): Promise<void>;
  (params: {
    name_in: string;
...
type ObjectDeleteObjectFn = {
  (name_in: string): Promise<void>;
  (params: { name_in: string }): Promise<void>;
};
...
type ObjectGetObjectHashesFn = {
  (name_in: string): Promise<Array<{ algorithm: string; hash: string }>>;
  (params: { name_in: string }): Promise<Array<{ algorithm: string; hash: string }>>;
};
...
type ObjectObjectUploadCompleteFn = {
  (name_in: string, upload_id_in: string): Promise<void>;
  (params: { name_in: string; upload_id_in: string }): Promise<void>;
};
...
type PurgeCacheExpireCachePurgesFn = {
  (expires_in: Date): Promise<[{ expire_cache_purges: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_cache_purges: number }]>;
};
/** @deprecated */
...
type PurgeCachePurgeCacheWpidFn = {
  (worker_pool_id_in: string, cache_name_in: string, before_in: Date, expires_in: Date): Promise<void>;
  (params: { worker_pool_id_in: string; cache_name_in: string; before_in: Date; expires_in: Date }): Promise<void>;
};
/** @deprecated */
...
type PurgeCachePurgeRequestsWpidFn = {
  (worker_pool_id_in: string): Promise<Array<{ worker_pool_id: string; cache_name: string; before: Date }>>;
  (params: { worker_pool_id_in: string }): Promise<Array<{ worker_pool_id: string; cache_name: string; before: Date }>>;
};
...
type QueueAzureQueueCountDeprecatedFn = {
  (queue_name: string): Promise<[{ azure_queue_count: number }]>;
  (params: { queue_name: string }): Promise<[{ azure_queue_count: number }]>;
};
/** @deprecated */
type QueueAzureQueueDeleteDeprecatedFn = {
  (queue_name: string, message_id: string, pop_receipt: string): Promise<void>;
  (params: { queue_name: string; message_id: string; pop_receipt: string }): Promise<void>;
};
/** @deprecated */
...
type QueueAzureQueuePutDeprecatedFn = {
  (queue_name: string, message_text: string, visible: any, expires: any): Promise<void>;
  (params: { queue_name: string; message_text: string; visible: any; expires: any }): Promise<void>;
};
/** @deprecated */
...
type QueueAzureQueueUpdateDeprecatedFn = {
  (queue_name: string, message_text: string, message_id: string, pop_receipt: string, visible: any): Promise<void>;
  (params: {
    queue_name: string;
    message_text: string;
    message_id: string;
...
type QueueCancelTaskFn = {
  (task_id: string, reason: string): Promise<Array<{ retries_left: number; runs: JsonB; taken_until: Date }>>;
  (params: {
    task_id: string;
    reason: string;
...
type QueueDeleteQueueArtifactFn = {
  (task_id_in: string, run_id_in: number, name_in: string): Promise<void>;
  (params: { task_id_in: string; run_id_in: number; name_in: string }): Promise<void>;
};
type QueueDeleteQueueArtifactsFn = {
  (task_id_run_id_names: JsonB): Promise<void>;
  (params: { task_id_run_id_names: JsonB }): Promise<void>;
};
type QueueDeleteQueueProvisionerFn = {
  (provisioner_id: string, stability: string, description: string): Promise<void>;
  (params: { provisioner_id: string; stability: string; description: string }): Promise<void>;
};
type QueueDeleteQueueWorkerTypeFn = {
  (provisioner_id: string, worker_type: string, stability: string, description: string): Promise<void>;
  (params: { provisioner_id: string; worker_type: string; stability: string; description: string }): Promise<void>;
};
type QueueEnsureTaskGroupFn = {
  (task_group_id_in: string, scheduler_id_in: string, expires_in: Date): Promise<void>;
  (params: { task_group_id_in: string; scheduler_id_in: string; expires_in: Date }): Promise<void>;
};
/** @deprecated */
type QueueExpireQueueProvisionersDeprecatedFn = {
  (expires_in: Date): Promise<[{ expire_queue_provisioners: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_queue_provisioners: number }]>;
};
/** @deprecated */
type QueueExpireQueueWorkerTypesDeprecatedFn = {
  (expires_in: Date): Promise<[{ expire_queue_worker_types: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_queue_worker_types: number }]>;
};
type QueueExpireQueueWorkersFn = {
  (expires_in: Date): Promise<[{ expire_queue_workers: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_queue_workers: number }]>;
};
type QueueExpireTaskDependenciesFn = {
  (expires_in: Date): Promise<[{ expire_task_dependencies: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_task_dependencies: number }]>;
};
type QueueExpireTaskGroupsFn = {
  (expires_in: Date): Promise<[{ expire_task_groups: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_task_groups: number }]>;
};
type QueueExpireTaskQueuesFn = {
  (expires_in: Date): Promise<[{ expire_task_queues: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_task_queues: number }]>;
};
type QueueExpireTasksFn = {
  (expires_in: Date): Promise<[{ expire_tasks: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_tasks: number }]>;
};
...
type QueueGetTaskGroupDeprecatedFn = {
  (task_group_id_in: string): Promise<Array<{ task_group_id: string; scheduler_id: string; expires: Date }>>;
  (params: {
    task_group_id_in: string;
  }): Promise<Array<{ task_group_id: string; scheduler_id: string; expires: Date }>>;
};
type QueueGetTaskGroupSizeFn = {
  (task_group_id_in: string): Promise<[{ get_task_group_size: number }]>;
  (params: { task_group_id_in: string }): Promise<[{ get_task_group_size: number }]>;
};
...
type QueueIsTaskBlockedFn = {
  (dependent_task_id_in: string): Promise<[{ is_task_blocked: boolean }]>;
  (params: { dependent_task_id_in: string }): Promise<[{ is_task_blocked: boolean }]>;
};
type QueueIsTaskGroupActiveFn = {
  (task_group_id_in: string): Promise<[{ is_task_group_active: boolean }]>;
  (params: { task_group_id_in: string }): Promise<[{ is_task_group_active: boolean }]>;
};
type QueueIsTaskGroupSealedFn = {
  (task_group_id_in: string): Promise<[{ is_task_group_sealed: boolean }]>;
  (params: { task_group_id_in: string }): Promise<[{ is_task_group_sealed: boolean }]>;
};
type QueueMarkTaskEverResolvedFn = {
  (task_id_in: string): Promise<void>;
  (params: { task_id_in: string }): Promise<void>;
};
/** @deprecated */
...
type QueueQueueClaimedTaskDeleteFn = {
  (task_id_in: string, pop_receipt_in: string): Promise<void>;
  (params: { task_id_in: string; pop_receipt_in: string }): Promise<void>;
};
...
type QueueQueueClaimedTaskResolvedFn = {
  (task_id_in: string, run_id_in: number): Promise<void>;
  (params: { task_id_in: string; run_id_in: number }): Promise<void>;
};
type QueueQueueClaimedTasksCountFn = {
  (task_queue_id_in: string): Promise<[{ queue_claimed_tasks_count: number }]>;
  (params: { task_queue_id_in: string }): Promise<[{ queue_claimed_tasks_count: number }]>;
};
...
type QueueQueuePendingTasksCountFn = {
  (task_queue_id_in: string): Promise<[{ queue_pending_tasks_count: number }]>;
  (params: { task_queue_id_in: string }): Promise<[{ queue_pending_tasks_count: number }]>;
};
...
type QueueQueueResolvedTaskGetFn = {
  (
    ...
    Array<{ task_id: string; task_group_id: string; scheduler_id: string; resolution: string; pop_receipt: string }>
  >;
  (params: {
    visible_in: Date;
    count: number;
...
type QueueQueueResolvedTaskPutFn = {
  (task_group_id_in: string, task_id_in: string, scheduler_id_in: string, resolution_in: string): Promise<void>;
  (params: {
    task_group_id_in: string;
    task_id_in: string;
...
type QueueQueueTaskDeadlineGetFn = {
  (
    ...
    Array<{ task_id: string; task_group_id: string; scheduler_id: string; deadline: Date; pop_receipt: string }>
  >;
  (params: {
    visible_in: Date;
    count: number;
...
type QueueQueueWorkerSeenDeprecatedFn = {
  (task_queue_id_in: string, worker_group_in: string, worker_id_in: string, expires_in: Date): Promise<void>;
  (params: {
    task_queue_id_in: string;
    worker_group_in: string;
    worker_id_in: string;
...
type QueueQueueWorkerTaskSeenFn = {
  (task_queue_id_in: string, worker_group_in: string, worker_id_in: string, task_run_in: JsonB): Promise<void>;
  (params: {
    task_queue_id_in: string;
    worker_group_in: string;
    worker_id_in: string;
...
type QueueRemoveTaskFn = {
  (task_id: string): Promise<void>;
  (params: { task_id: string }): Promise<void>;
};
type QueueRemoveTaskDependenciesFn = {
  (dependent_task_id_in: string, required_task_ids_in: JsonB): Promise<void>;
  (params: { dependent_task_id_in: string; required_task_ids_in: JsonB }): Promise<void>;
};
type QueueRemoveTaskDependencyFn = {
  (dependent_task_id_in: string, required_task_id_in: string): Promise<void>;
  (params: { dependent_task_id_in: string; required_task_id_in: string }): Promise<void>;
};
type QueueRerunTaskFn = {
  (task_id: string): Promise<Array<{ retries_left: number; runs: JsonB; taken_until: Date }>>;
  (params: { task_id: string }): Promise<Array<{ retries_left: number; runs: JsonB; taken_until: Date }>>;
};
...
type QueueScheduleTaskFn = {
  (task_id: string, reason_created: string): Promise<Array<{ retries_left: number; runs: JsonB; taken_until: Date }>>;
  (params: {
    task_id: string;
...
type QueueTaskQueueSeenFn = {
  (task_queue_id_in: string, expires_in: Date, description_in: string, stability_in: string): Promise<void>;
  (params: { task_queue_id_in: string; expires_in: Date; description_in: string; stability_in: string }): Promise<void>;
};
/** @deprecated */
...
type SecretsExpireSecretsDeprecatedFn = {
  ...
  (params: {}): Promise<[{ expire_secrets: number }]>;
};
type SecretsExpireSecretsReturnNamesFn = {
  (): Promise<Array<{ name: string }>>;
  (params: {}): Promise<Array<{ name: string }>>;
};
type SecretsGetSecretFn = {
  (name_in: string): Promise<Array<{ name: string; encrypted_secret: JsonB; expires: Date }>>;
  (params: { name_in: string }): Promise<Array<{ name: string; encrypted_secret: JsonB; expires: Date }>>;
};
type SecretsGetSecretsFn = {
  (page_size_in: number | null, page_offset_in: number | null): Promise<Array<{ name: string }>>;
  (params: { page_size_in?: number | null; page_offset_in?: number | null }): Promise<Array<{ name: string }>>;
};
type SecretsInsertSecretsAuditHistoryFn = {
  (secret_id_in: string, client_id_in: string, action_type_in: string): Promise<void>;
  (params: { secret_id_in: string; client_id_in: string; action_type_in: string }): Promise<void>;
};
/** @deprecated */
...
type SecretsUpsertSecretFn = {
  (name_in: string, encrypted_secret_in: JsonB, expires_in: Date): Promise<void>;
  (params: { name_in: string; encrypted_secret_in: JsonB; expires_in: Date }): Promise<void>;
};
...
type WebServerAddGithubAccessTokenFn = {
  (user_id_in: string, encrypted_access_token_in: JsonB): Promise<void>;
  (params: { user_id_in: string; encrypted_access_token_in: JsonB }): Promise<void>;
};
/** @deprecated */
...
type WebServerExpireAccessTokensFn = {
  (expires_in: Date): Promise<[{ expire_access_tokens: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_access_tokens: number }]>;
};
type WebServerExpireAuthorizationCodesFn = {
  (expires_in: Date): Promise<[{ expire_authorization_codes: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_authorization_codes: number }]>;
};
type WebServerExpireSessionsFn = {
  (): Promise<[{ expire_sessions: number }]>;
  (params: {}): Promise<[{ expire_sessions: number }]>;
};
...
type WebServerLoadGithubAccessTokenFn = {
  (user_id_in: string): Promise<Array<{ encrypted_access_token: JsonB }>>;
  (params: { user_id_in: string }): Promise<Array<{ encrypted_access_token: JsonB }>>;
};
type WebServerSessionAddFn = {
  (hashed_session_id_in: string, encrypted_session_id_in: JsonB, data_in: JsonB, expires_in: Date): Promise<void>;
  (params: {
...
type WebServerSessionRemoveFn = {
  (hashed_session_id_in: string): Promise<void>;
  (params: { hashed_session_id_in: string }): Promise<void>;
};
/** @deprecated */
...
type WebServerSessionTouchFn = {
  (hashed_session_id_in: string, data_in: JsonB, expires_in: Date): Promise<void>;
  (params: { hashed_session_id_in: string; data_in: JsonB; expires_in: Date }): Promise<void>;
};
// worker_manager function signatures

type WorkerManagerCollectLaunchConfigsIfExistFn = {
  (config_in: JsonB, worker_pool_id_in: string): Promise<[{ collect_launch_configs_if_exist: JsonB }]>;
  (params: { config_in: JsonB; worker_pool_id_in: string }): Promise<[{ collect_launch_configs_if_exist: JsonB }]>;
};
/** @deprecated */
...
type WorkerManagerDeleteWorkerFn = {
  (worker_pool_id_in: string, worker_group_in: string, worker_id_in: string): Promise<void>;
  (params: { worker_pool_id_in: string; worker_group_in: string; worker_id_in: string }): Promise<void>;
};
type WorkerManagerDeleteWorkerPoolFn = {
  (worker_pool_id_in: string): Promise<void>;
  (params: { worker_pool_id_in: string }): Promise<void>;
};
type WorkerManagerDeleteWorkerPoolErrorFn = {
  (error_id_in: string, worker_pool_id_in: string): Promise<void>;
  (params: { error_id_in: string; worker_pool_id_in: string }): Promise<void>;
};
type WorkerManagerExpireWorkerPoolErrorsFn = {
  (expires_in: Date): Promise<[{ expire_worker_pool_errors: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_worker_pool_errors: number }]>;
};
type WorkerManagerExpireWorkerPoolLaunchConfigsFn = {
  (): Promise<Array<{ launch_config_id: string }>>;
  (params: {}): Promise<Array<{ launch_config_id: string }>>;
};
type WorkerManagerExpireWorkerPoolsFn = {
  (): Promise<Array<{ worker_pool_id: string }>>;
  (params: {}): Promise<Array<{ worker_pool_id: string }>>;
};
type WorkerManagerExpireWorkersFn = {
  (expires_in: Date): Promise<[{ expire_workers: number }]>;
  (params: { expires_in: Date }): Promise<[{ expire_workers: number }]>;
};
/** @deprecated */
...
type WorkerManagerGetWorkerPoolErrorCodesFn = {
  (worker_pool_id_in: string | null): Promise<Array<{ code: string; count: number }>>;
  (params: { worker_pool_id_in?: string | null }): Promise<Array<{ code: string; count: number }>>;
};
...
type WorkerManagerGetWorkerPoolErrorStatsLast24HoursFn = {
  (worker_pool_id_in: string | null): Promise<Array<{ hour: Date; count: number }>>;
  (params: { worker_pool_id_in?: string | null }): Promise<Array<{ hour: Date; count: number }>>;
};
type WorkerManagerGetWorkerPoolErrorStatsLast7DaysFn = {
  (worker_pool_id_in: string | null): Promise<Array<{ day: Date; count: number }>>;
  (params: { worker_pool_id_in?: string | null }): Promise<Array<{ day: Date; count: number }>>;
};
type WorkerManagerGetWorkerPoolErrorTitlesFn = {
  (worker_pool_id_in: string | null): Promise<Array<{ title: string; count: number }>>;
  (params: { worker_pool_id_in?: string | null }): Promise<Array<{ title: string; count: number }>>;
};
type WorkerManagerGetWorkerPoolErrorWorkerPoolsFn = {
  (worker_pool_id_in: string | null): Promise<Array<{ worker_pool: string; count: number }>>;
  (params: { worker_pool_id_in?: string | null }): Promise<Array<{ worker_pool: string; count: number }>>;
};
/** @deprecated */
...
type WorkerManagerGetWorkerPoolLaunchConfigStatsFn = {
  (worker_pool_id_in: string): Promise<Array<{ state: string; launch_config_id: string; count: any }>>;
  (params: { worker_pool_id_in: string }): Promise<Array<{ state: string; launch_config_id: string; count: any }>>;
};
...
type WorkerManagerInsertWorkerManagerAuditHistoryFn = {
  (worker_pool_id_in: string, client_id_in: string, action_type_in: string): Promise<void>;
  (params: { worker_pool_id_in: string; client_id_in: string; action_type_in: string }): Promise<void>;
};
type WorkerManagerRemoveWorkerPoolPreviousProviderIdFn = {
  (worker_pool_id_in: string, provider_id_in: string): Promise<void>;
  (params: { worker_pool_id_in: string; provider_id_in: string }): Promise<void>;
};
/** @deprecated */
...
type WorkerManagerUpdateWorkerPoolProviderDataFn = {
  (worker_pool_id_in: string, provider_id_in: string, provider_data_in: JsonB): Promise<void>;
  (params: { worker_pool_id_in: string; provider_id_in: string; provider_data_in: JsonB }): Promise<void>;
};
/** @deprecated */
...
type WorkerManagerUpdateWorkerPoolWithLaunchConfigsFn = {
  (
    ...
    Array<{
      ...
      email_on_error: boolean;
      previous_provider_id: string;
      updated_launch_configs: any;
      created_launch_configs: any;
      archived_launch_configs: any;
    }>
  >;
  (params: {
    worker_pool_id_in: string;
