...
The format for the tarball that is uploaded to s3 is [documented here](https://github.com/taskcluster/taskcluster-lib-docs/blob/master/docs/format.mdx).
...
A top-level `README.mdx` will be uploaded automatically.
...
```js
    ...
    // The path to the README.mdx file for the project
    readme: '<project root>/README.mdx',
