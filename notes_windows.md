...
md C:\generic-worker
$client.DownloadFile("https://github.com/taskcluster/generic-worker/releases/download/v1.0.7/generic-worker-windows-amd64.exe", "C:\generic-worker\generic-worker.exe")
