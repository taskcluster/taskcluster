...
//
//  eC2Manager := ec2manager.New(&tcclient.Credentials{ClientID: "myClientID", AccessToken: "myAccessToken"})
//
...
//
//  eC2Manager, err := ec2manager.New(nil)                           // credentials loaded from TASKCLUSTER_* env vars
//  if err != nil {
