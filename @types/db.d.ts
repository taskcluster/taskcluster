...
export declare class DatabaseFns implements DbFunctions {
...
export declare class DatabaseDeprecatedFns implements DeprecatedDbFunctions {
  constructor(config: any);
...
export declare const db: {
  fns: DatabaseFns;
  deprecatedFns: DatabaseDeprecatedFns;
};
