...
docker pull taskcluster/relengapi-proxy:2.3.0
...
docker save taskcluster/taskcluster-proxy:4.0.1 taskcluster/livelog:v4 taskcluster/dind-service:v4.0 taskcluster/relengapi-proxy:2.3.0 > /home/ubuntu/docker_worker/docker_worker_images.tar
