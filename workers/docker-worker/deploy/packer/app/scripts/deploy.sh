...
docker pull taskcluster/relengapi-proxy:2.1.0

# Export the images as a tarball to load when insances are initialized
docker save taskcluster/taskcluster-proxy:latest taskcluster/livelog:v4 taskcluster/dind-service:v4.0 taskcluster/relengapi-proxy:2.1.0 > /home/ubuntu/docker_worker/docker_worker_images.tar
