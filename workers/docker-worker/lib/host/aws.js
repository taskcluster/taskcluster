...
export async function configure(baseUrl=BASE_URL) {
  ...
  let userSuppliedData = userdata.data;
  ...
  delete userdata.provisionerBaseUrl;
  ...
  return Object.assign(config, userdata, userSuppliedData, credentials, secrets.data);
}
