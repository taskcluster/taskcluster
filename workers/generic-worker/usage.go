        ...
        ** OPTIONAL ** properties
        =========================
          ...
          disableOOMProtection              If true, the worker will continue to monitor system
                                            ...
                                            AND maxSystemMemoryPercent for longer than
                                            highMemoryTimeoutSecs seconds.
                                            [default: false]
          ...
          highMemoryTimeoutSecs             The number of seconds the resource monitor will
                                            allow the system memory usage to be above the high
                                            memory thresholds (see minAvailableMemoryBytes
                                            and maxSystemMemoryPercent) before aborting
          ...
          maxSystemMemoryPercent            A percent used by the resource monitor to determine
                                            ...
                                            highMemoryTimeoutSecs seconds. Can be used
          ...
          minAvailableMemoryBytes           Number of bytes the resource monitor uses to
                                            ...
                                            for longer than highMemoryTimeoutSecs seconds.
                                            Can be used in conjunction with maxSystemMemoryPercent.
                                            Does nothing if disableOOMProtection is set to true.
