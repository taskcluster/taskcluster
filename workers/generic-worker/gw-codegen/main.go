...
import (
	...
	"github.com/taskcluster/taskcluster/v66/internal/jsontest"
...
func formatSourceAndSave(sourceCode []byte, sourceFile string) error {
	...
	if err == nil {
		...
		fixedFixedImports = importFixer.ReplaceAll(fixedImports, []byte("github.com/taskcluster/taskcluster/v66/"))
	}
