...
See the [![GoDoc](https://pkg.go.dev/github.com/taskcluster/taskcluster/v105/workers/generic-worker?status.svg)](https://pkg.go.dev/github.com/taskcluster/taskcluster/v105/workers/generic-worker).
