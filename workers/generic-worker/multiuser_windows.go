...
import (
	...
	"github.com/taskcluster/taskcluster/v72/workers/generic-worker/win32"
...
func changeOwnerhipInDir(dir string, currentOwnerUID string, newOwnerUsername string) error {
