...
import (
	...
	"github.com/taskcluster/taskcluster/v99/workers/generic-worker/mockec2"
)
...
func GWTest(t *testing.T) *Test {
	...
	return &Test{
		...
		PreviousEC2TokenURL:        EC2TokenURL,
...
func (gwtest *Test) MockEC2(bootstrapConfig any) *mockec2.Metadata {
...
awsProviderSearch:
	...
	EC2TokenURL = "http://localhost:13243/latest/api/token"
	...
	var bootstrapConfigMap map[string]any
	...
	workerPoolDefinition := map[string]any{
		"minCapacity": 0,
		"maxCapacity": 0,
...
func (gwtest *Test) Teardown() {
	...
	EC2TokenURL = gwtest.PreviousEC2TokenURL
