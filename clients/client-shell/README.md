...
```shell
curl -L https://github.com/taskcluster/taskcluster/releases/download/v44.9.2/taskcluster-darwin-amd64 --output taskcluster
```
This is to ensure the binary is not quarantined by MacOS.
You will need to `chmod +x` of
course.

 * [linux-amd64](https://github.com/taskcluster/taskcluster/releases/download/v44.9.2/taskcluster-linux-amd64)
 * [darwin-amd64](https://github.com/taskcluster/taskcluster/releases/download/v44.9.2/taskcluster-darwin-amd64)
