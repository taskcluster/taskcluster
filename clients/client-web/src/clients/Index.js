...
export default class Index extends Client {
  constructor(options = {}) {
    ...
    this.listNamespaces.entry = {"args":["namespace"],"category":"Index Service","method":"get","name":"listNamespaces","output":true,"query":["continuationToken","limit"],"route":"/namespaces/<namespace>","scopes":{"else":"index:list-namespaces","if":"namespace","then":"index:list-namespaces:<namespace>"},"stability":"stable","type":"function"}; // eslint-disable-line
    this.listTasks.entry = {"args":["namespace"],"category":"Index Service","method":"get","name":"listTasks","output":true,"query":["continuationToken","limit"],"route":"/tasks/<namespace>","scopes":{"else":"index:list-tasks","if":"namespace","then":"index:list-tasks:<namespace>"},"stability":"stable","type":"function"}; // eslint-disable-line
