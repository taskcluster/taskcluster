...
export default class Hooks extends Client {
  constructor(options = {}) {
    ...
    this.listHookGroups.entry = {"args":[],"category":"Hooks Service","method":"get","name":"listHookGroups","output":true,"query":[],"route":"/hooks","stability":"stable","type":"function"}; // eslint-disable-line
    this.listHooks.entry = {"args":["hookGroupId"],"category":"Hooks Service","method":"get","name":"listHooks","output":true,"query":[],"route":"/hooks/<hookGroupId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.hook.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","method":"get","name":"hook","output":true,"query":[],"route":"/hooks/<hookGroupId>/<hookId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.getHookStatus.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","method":"get","name":"getHookStatus","output":true,"query":[],"route":"/hooks/<hookGroupId>/<hookId>/status","stability":"deprecated","type":"function"}; // eslint-disable-line
    this.createHook.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","input":true,"method":"put","name":"createHook","output":true,"query":[],"route":"/hooks/<hookGroupId>/<hookId>","scopes":{"AllOf":["hooks:modify-hook:<hookGroupId>/<hookId>","assume:hook-id:<hookGroupId>/<hookId>"]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.updateHook.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","input":true,"method":"post","name":"updateHook","output":true,"query":[],"route":"/hooks/<hookGroupId>/<hookId>","scopes":{"AllOf":["hooks:modify-hook:<hookGroupId>/<hookId>","assume:hook-id:<hookGroupId>/<hookId>"]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.removeHook.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","method":"delete","name":"removeHook","query":[],"route":"/hooks/<hookGroupId>/<hookId>","scopes":"hooks:modify-hook:<hookGroupId>/<hookId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.triggerHook.entry = {"args":["hookGroupId","hookId"],"category":"Hooks Service","input":true,"method":"post","name":"triggerHook","output":true,"query":[],"route":"/hooks/<hookGroupId>/<hookId>/trigger","scopes":"hooks:trigger-hook:<hookGroupId>/<hookId>","stability":"stable","type":"function"}; // eslint-disable-line
