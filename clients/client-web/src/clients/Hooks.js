...
export default class Hooks extends Client {
  constructor(options = {}) {
    ...
    this.searchHooks.entry = {"args":[],"category":"Hooks","method":"get","name":"searchHooks","output":true,"query":["continuationToken","limit","q"],"route":"/hooks/search","scopes":"hooks:list-hooks:","stability":"stable","type":"function"}; // eslint-disable-line
