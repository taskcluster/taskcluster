...
export default class Queue extends Client {
  constructor(options = {}) {
    ...
    this.task.entry = {"args":["taskId"],"method":"get","name":"task","output":true,"query":[],"route":"/task/<taskId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.status.entry = {"args":["taskId"],"method":"get","name":"status","output":true,"query":[],"route":"/task/<taskId>/status","stability":"stable","type":"function"}; // eslint-disable-line
    this.listTaskGroup.entry = {"args":["taskGroupId"],"method":"get","name":"listTaskGroup","output":true,"query":["continuationToken","limit"],"route":"/task-group/<taskGroupId>/list","stability":"stable","type":"function"}; // eslint-disable-line
    this.listDependentTasks.entry = {"args":["taskId"],"method":"get","name":"listDependentTasks","output":true,"query":["continuationToken","limit"],"route":"/task/<taskId>/dependents","stability":"stable","type":"function"}; // eslint-disable-line
    this.createTask.entry = {"args":["taskId"],"input":true,"method":"put","name":"createTask","output":true,"query":[],"route":"/task/<taskId>","scopes":{"AllOf":[{"each":"<scope>","for":"scope","in":"scopes"},{"each":"queue:route:<route>","for":"route","in":"routes"},{"AnyOf":[{"AllOf":["queue:scheduler-id:<schedulerId>",{"AnyOf":[{"each":"queue:create-task:<priority>:<provisionerId>/<workerType>","for":"priority","in":"priorities"}]}]},{"if":"legacyScopes","then":{"AnyOf":["queue:create-task:<provisionerId>/<workerType>",{"AllOf":["queue:define-task:<provisionerId>/<workerType>","queue:task-group-id:<schedulerId>/<taskGroupId>","queue:schedule-task:<schedulerId>/<taskGroupId>/<taskId>"]}]}}]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.defineTask.entry = {"args":["taskId"],"input":true,"method":"post","name":"defineTask","output":true,"query":[],"route":"/task/<taskId>/define","scopes":{"AllOf":[{"each":"<scope>","for":"scope","in":"scopes"},{"each":"queue:route:<route>","for":"route","in":"routes"},{"AnyOf":[{"AllOf":["queue:scheduler-id:<schedulerId>",{"AnyOf":[{"each":"queue:create-task:<priority>:<provisionerId>/<workerType>","for":"priority","in":"priorities"}]}]},{"if":"legacyScopes","then":{"AnyOf":["queue:define-task:<provisionerId>/<workerType>","queue:create-task:<provisionerId>/<workerType>",{"AllOf":["queue:define-task:<provisionerId>/<workerType>","queue:task-group-id:<schedulerId>/<taskGroupId>"]}]}}]}]},"stability":"deprecated","type":"function"}; // eslint-disable-line
    this.scheduleTask.entry = {"args":["taskId"],"method":"post","name":"scheduleTask","output":true,"query":[],"route":"/task/<taskId>/schedule","scopes":{"AnyOf":["queue:schedule-task:<schedulerId>/<taskGroupId>/<taskId>",{"AllOf":["queue:schedule-task","assume:scheduler-id:<schedulerId>/<taskGroupId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.rerunTask.entry = {"args":["taskId"],"method":"post","name":"rerunTask","output":true,"query":[],"route":"/task/<taskId>/rerun","scopes":{"AnyOf":["queue:rerun-task:<schedulerId>/<taskGroupId>/<taskId>",{"AllOf":["queue:rerun-task","assume:scheduler-id:<schedulerId>/<taskGroupId>"]}]},"stability":"deprecated","type":"function"}; // eslint-disable-line
    this.cancelTask.entry = {"args":["taskId"],"method":"post","name":"cancelTask","output":true,"query":[],"route":"/task/<taskId>/cancel","scopes":{"AnyOf":["queue:cancel-task:<schedulerId>/<taskGroupId>/<taskId>",{"AllOf":["queue:cancel-task","assume:scheduler-id:<schedulerId>/<taskGroupId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.claimWork.entry = {"args":["provisionerId","workerType"],"input":true,"method":"post","name":"claimWork","output":true,"query":[],"route":"/claim-work/<provisionerId>/<workerType>","scopes":{"AllOf":["queue:claim-work:<provisionerId>/<workerType>","queue:worker-id:<workerGroup>/<workerId>"]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.claimTask.entry = {"args":["taskId","runId"],"input":true,"method":"post","name":"claimTask","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/claim","scopes":{"AnyOf":[{"AllOf":["queue:claim-task:<provisionerId>/<workerType>","queue:worker-id:<workerGroup>/<workerId>"]},{"AllOf":["queue:claim-task","assume:worker-type:<provisionerId>/<workerType>","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"deprecated","type":"function"}; // eslint-disable-line
    this.reclaimTask.entry = {"args":["taskId","runId"],"method":"post","name":"reclaimTask","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/reclaim","scopes":{"AnyOf":["queue:reclaim-task:<taskId>/<runId>",{"AllOf":["queue:claim-task","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.reportCompleted.entry = {"args":["taskId","runId"],"method":"post","name":"reportCompleted","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/completed","scopes":{"AnyOf":["queue:resolve-task:<taskId>/<runId>",{"AllOf":["queue:resolve-task","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.reportFailed.entry = {"args":["taskId","runId"],"method":"post","name":"reportFailed","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/failed","scopes":{"AnyOf":["queue:resolve-task:<taskId>/<runId>",{"AllOf":["queue:resolve-task","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.reportException.entry = {"args":["taskId","runId"],"input":true,"method":"post","name":"reportException","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/exception","scopes":{"AnyOf":["queue:resolve-task:<taskId>/<runId>",{"AllOf":["queue:resolve-task","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.createArtifact.entry = {"args":["taskId","runId","name"],"input":true,"method":"post","name":"createArtifact","output":true,"query":[],"route":"/task/<taskId>/runs/<runId>/artifacts/<name>","scopes":{"AnyOf":["queue:create-artifact:<taskId>/<runId>",{"AllOf":["queue:create-artifact:<name>","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"stable","type":"function"}; // eslint-disable-line
    this.completeArtifact.entry = {"args":["taskId","runId","name"],"input":true,"method":"put","name":"completeArtifact","query":[],"route":"/task/<taskId>/runs/<runId>/artifacts/<name>","scopes":{"AnyOf":["queue:create-artifact:<taskId>/<runId>",{"AllOf":["queue:create-artifact:<name>","assume:worker-id:<workerGroup>/<workerId>"]}]},"stability":"experimental","type":"function"}; // eslint-disable-line
    this.getArtifact.entry = {"args":["taskId","runId","name"],"method":"get","name":"getArtifact","query":[],"route":"/task/<taskId>/runs/<runId>/artifacts/<name>","scopes":{"if":"private","then":{"AllOf":["queue:get-artifact:<name>"]}},"stability":"stable","type":"function"}; // eslint-disable-line
    this.getLatestArtifact.entry = {"args":["taskId","name"],"method":"get","name":"getLatestArtifact","query":[],"route":"/task/<taskId>/artifacts/<name>","scopes":{"if":"private","then":{"AllOf":["queue:get-artifact:<name>"]}},"stability":"stable","type":"function"}; // eslint-disable-line
    this.listArtifacts.entry = {"args":["taskId","runId"],"method":"get","name":"listArtifacts","output":true,"query":["continuationToken","limit"],"route":"/task/<taskId>/runs/<runId>/artifacts","stability":"experimental","type":"function"}; // eslint-disable-line
    this.listLatestArtifacts.entry = {"args":["taskId"],"method":"get","name":"listLatestArtifacts","output":true,"query":["continuationToken","limit"],"route":"/task/<taskId>/artifacts","stability":"experimental","type":"function"}; // eslint-disable-line
    this.listProvisioners.entry = {"args":[],"method":"get","name":"listProvisioners","output":true,"query":["continuationToken","limit"],"route":"/provisioners","stability":"experimental","type":"function"}; // eslint-disable-line
    ...
    this.lastClaimed.entry = {"args":["provisionerId","workerType"],"method":"get","name":"lastClaimed","output":true,"query":[],"route":"/last_claimed/<provisionerId>/<workerType>","stability":"experimental","type":"function"}; // eslint-disable-line
    ...
    this.listWorkers.entry = {"args":["provisionerId","workerType"],"method":"get","name":"listWorkers","output":true,"query":["continuationToken","limit","quarantined"],"route":"/provisioners/<provisionerId>/worker-types/<workerType>/workers","stability":"experimental","type":"function"}; // eslint-disable-line
    this.getWorker.entry = {"args":["provisionerId","workerType","workerGroup","workerId"],"method":"get","name":"getWorker","output":true,"query":[],"route":"/provisioners/<provisionerId>/worker-types/<workerType>/workers/<workerGroup>/<workerId>","stability":"experimental","type":"function"}; // eslint-disable-line
    this.quarantineWorker.entry = {"args":["provisionerId","workerType","workerGroup","workerId"],"input":true,"method":"put","name":"quarantineWorker","output":true,"query":[],"route":"/provisioners/<provisionerId>/worker-types/<workerType>/workers/<workerGroup>/<workerId>","scopes":{"AllOf":["queue:quarantine-worker:<provisionerId>/<workerType>/<workerGroup>/<workerId>"]},"stability":"experimental","type":"function"}; // eslint-disable-line
    this.declareWorker.entry = {"args":["provisionerId","workerType","workerGroup","workerId"],"input":true,"method":"put","name":"declareWorker","output":true,"query":[],"route":"/provisioners/<provisionerId>/worker-types/<workerType>/<workerGroup>/<workerId>","scopes":{"AllOf":[{"each":"queue:declare-worker:<provisionerId>/<workerType>/<workerGroup>/<workerId>#<property>","for":"property","in":"properties"}]},"stability":"experimental","type":"function"}; // eslint-disable-line
  }
