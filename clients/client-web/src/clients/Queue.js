...
export default class Queue extends Client {
  constructor(options = {}) {
    ...
    this.listArtifacts.entry = {"args":["taskId","runId"],"category":"Queue Service","method":"get","name":"listArtifacts","output":true,"query":["continuationToken","limit"],"route":"/task/<taskId>/runs/<runId>/artifacts","stability":"stable","type":"function"}; // eslint-disable-line
    this.listLatestArtifacts.entry = {"args":["taskId"],"category":"Queue Service","method":"get","name":"listLatestArtifacts","output":true,"query":["continuationToken","limit"],"route":"/task/<taskId>/artifacts","stability":"stable","type":"function"}; // eslint-disable-line
