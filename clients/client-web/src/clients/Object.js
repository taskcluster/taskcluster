...
export default class Object extends Client {
  constructor(options = {}) {
    ...
    this.uploadObject.entry = {"args":["name"],"category":"Upload","input":true,"method":"put","name":"uploadObject","query":[],"route":"/upload/<name>","scopes":"object:upload:<name>","stability":"experimental","type":"function"}; // eslint-disable-line
