...
export default class Auth extends Client {
  constructor(options = {}) {
    ...
    this.gcpCredentials.entry = {"args":["serviceAccount"],"method":"get","name":"gcpCredentials","output":true,"query":[],"route":"/gcp/credentials/<serviceAccount>","scopes":"auth:gcp:access-token:<serviceAccount>","stability":"stable","type":"function"}; // eslint-disable-line
