...
export default class Auth extends Client {
  constructor(options = {}) {
    ...
    this.listAuditHistory.entry = {"args":["clientId"],"category":"Audit","method":"get","name":"listAuditHistory","output":true,"query":["continuationToken","limit"],"route":"/audit-logs/<clientId>","stability":"stable","type":"function"}; // eslint-disable-line
