...
export default class WebServer extends Client {
  constructor(options = {}) {
    ...
    this.taskGroupProfile.entry = {"args":["taskGroupId"],"category":"Profiler","method":"get","name":"taskGroupProfile","query":[],"route":"/task-group/<taskGroupId>/profile","stability":"experimental","type":"function"};
    this.taskProfile.entry = {"args":["taskId"],"category":"Profiler","method":"get","name":"taskProfile","query":[],"route":"/task/<taskId>/profile","stability":"experimental","type":"function"};
