...
export default class WorkerManager extends Client {
  constructor(options = {}) {
    ...
    this.deleteWorkerPool.entry = {"args":["workerPoolId"],"category":"Worker Manager","method":"delete","name":"deleteWorkerPool","output":true,"query":[],"route":"/worker-pool/<workerPoolId>","scopes":"worker-manager:manage-worker-pool:<workerPoolId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.workerPool.entry = {"args":["workerPoolId"],"category":"Worker Manager","method":"get","name":"workerPool","output":true,"query":[],"route":"/worker-pool/<workerPoolId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.listWorkerPools.entry = {"args":[],"category":"Worker Manager","method":"get","name":"listWorkerPools","output":true,"query":["continuationToken","limit"],"route":"/worker-pools","stability":"stable","type":"function"}; // eslint-disable-line
    ...
    this.listWorkerPoolErrors.entry = {"args":["workerPoolId"],"category":"Worker Manager","method":"get","name":"listWorkerPoolErrors","output":true,"query":["continuationToken","limit"],"route":"/worker-pool-errors/<workerPoolId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.listWorkersForWorkerGroup.entry = {"args":["workerPoolId","workerGroup"],"category":"Worker Manager","method":"get","name":"listWorkersForWorkerGroup","output":true,"query":["continuationToken","limit"],"route":"/workers/<workerPoolId>:/<workerGroup>","stability":"stable","type":"function"}; // eslint-disable-line
    this.worker.entry = {"args":["workerPoolId","workerGroup","workerId"],"category":"Worker Manager","method":"get","name":"worker","output":true,"query":[],"route":"/workers/<workerPoolId>:/<workerGroup>/<workerId>","stability":"stable","type":"function"}; // eslint-disable-line
    ...
    this.removeWorker.entry = {"args":["workerPoolId","workerGroup","workerId"],"category":"Worker Manager","method":"delete","name":"removeWorker","query":[],"route":"/workers/<workerPoolId>/<workerGroup>/<workerId>","scopes":"worker-manager:remove-worker:<workerPoolId>/<workerGroup>/<workerId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.listWorkersForWorkerPool.entry = {"args":["workerPoolId"],"category":"Worker Manager","method":"get","name":"listWorkersForWorkerPool","output":true,"query":["continuationToken","limit"],"route":"/workers/<workerPoolId>","stability":"stable","type":"function"}; // eslint-disable-line
    this.registerWorker.entry = {"args":[],"category":"Worker Manager","input":true,"method":"post","name":"registerWorker","output":true,"query":[],"route":"/worker/register","stability":"stable","type":"function"}; // eslint-disable-line
  }
