...
export default class WorkerManager extends Client {
  constructor(options = {}) {
    ...
    this.registerWorker.entry = {"args":[],"category":"Worker Manager","input":true,"method":"get","name":"registerWorker","output":true,"query":[],"route":"/worker/register","stability":"experimental","type":"function"}; // eslint-disable-line
  }
