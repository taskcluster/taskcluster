...
export default class Github extends Client {
  constructor(options = {}) {
    ...
    this.githubWebHookConsumer.entry = {"args":[],"category":"Github Service","input":true,"method":"post","name":"githubWebHookConsumer","query":[],"route":"/github","stability":"stable","type":"function"}; // eslint-disable-line
