...
func (api *API) generateAPICode(apiName string) string {
	...
	comment += "// " + api.apiDef.URL + " together with the input and output schemas it references,\n"
	comment += "// The code was generated by\n"
	comment += "// https://github.com/taskcluster/taskcluster/clients/client-go/blob/master/build.sh.\n"
