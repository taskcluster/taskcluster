...
// https://taskcluster-staging.net/references/purge-cache/v1/api.json together with the input and output schemas it references,
// The code was generated by
// https://github.com/taskcluster/taskcluster/clients/client-go/blob/master/build.sh.
