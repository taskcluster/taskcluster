...
[![GoDoc](https://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18?status.svg)](https://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18)
...
Complete godoc documentation [here](https://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18).

This library provides the following packages to interface with Taskcluster:

### HTTP APIs
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauth
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcawsprovisioner
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcec2manager
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcgithub
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tchooks
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcindex
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tclogin
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcnotify
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcpurgecache
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcqueue
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcsecrets

### AMQP APIs
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauthevents
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcawsprovisionerevents
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcgithubevents
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcpurgecacheevents
* http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcqueueevents

## Example programs

To get you started quickly, some example programs are included that use both the HTTP APIs and the AMQP APIs:

* This [HTTP example program](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauth#example-package--Scopes) demonstrates the use of the [tcauth](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauth) package to query the expiry and expanded scopes of a given clientId.
* This [HTTP example program](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauth#example-package--UpdateClient) demonstrates the use of the [tcauth](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcauth) package to update an existing clientId with a new description and expiry.
* The [AMQP example program](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcqueueevents#example-package--TaskclusterSniffer) demonstrates the use of the [tcqueueevents](http://godoc.org/github.com/taskcluster/taskcluster/clients/client-go/v18/tcqueueevents) package to listen in on Taskcluster tasks being defined and executed.
