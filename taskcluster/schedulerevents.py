...
class SchedulerEvents(BaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphExtended', 'routingKey': [{'multipleWords': False, 'name': 'routingKeyKind', 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary'}, {'multipleWords': False, 'name': 'taskId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'runId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerGroup', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'provisionerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerType', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'schedulerId', 'required': True, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {'multipleWords': False, 'name': 'taskGraphId', 'required': True, 'summary': 'Identifier for the task-graph this message concerns'}, {'multipleWords': True, 'name': 'reserved', 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'exchange': 'task-graph-extended', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphBlocked', 'routingKey': [{'multipleWords': False, 'name': 'routingKeyKind', 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary'}, {'multipleWords': False, 'name': 'taskId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'runId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerGroup', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'provisionerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerType', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'schedulerId', 'required': True, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {'multipleWords': False, 'name': 'taskGraphId', 'required': True, 'summary': 'Identifier for the task-graph this message concerns'}, {'multipleWords': True, 'name': 'reserved', 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'exchange': 'task-graph-blocked', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphFinished', 'routingKey': [{'multipleWords': False, 'name': 'routingKeyKind', 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary'}, {'multipleWords': False, 'name': 'taskId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'runId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerGroup', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'provisionerId', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'workerType', 'required': False, 'summary': 'Always takes the value `_`'}, {'multipleWords': False, 'name': 'schedulerId', 'required': True, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {'multipleWords': False, 'name': 'taskGraphId', 'required': True, 'summary': 'Identifier for the task-graph this message concerns'}, {'multipleWords': True, 'name': 'reserved', 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'exchange': 'task-graph-finished', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#'}, *args, **kwargs)
