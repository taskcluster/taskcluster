...
class SchedulerEvents(BaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphExtended', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': 'Always takes the value `_`', 'name': 'taskId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'provisionerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerType', 'multipleWords': False, 'required': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-graph-extended'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphBlocked', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': 'Always takes the value `_`', 'name': 'taskId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'provisionerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerType', 'multipleWords': False, 'required': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-graph-blocked'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGraphFinished', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': 'Always takes the value `_`', 'name': 'taskId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'provisionerId', 'multipleWords': False, 'required': False}, {'summary': 'Always takes the value `_`', 'name': 'workerType', 'multipleWords': False, 'required': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-graph-finished'}, *args, **kwargs)
