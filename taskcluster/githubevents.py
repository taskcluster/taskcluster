...
class GithubEvents(BaseClient):
    ...
    def pullRequest(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'organization', 'multipleWords': False}, {'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'repository', 'multipleWords': False}, {'summary': 'The GitHub `action` which triggered an event. See for possible values see the payload actions property.', 'required': True, 'name': 'action', 'multipleWords': False}], 'schema': 'http://schemas.taskcluster.net/github/v1/github-pull-request-message.json#', 'name': 'pullRequest', 'exchange': 'pull-request'}, *args, **kwargs)
    ...
    def push(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'organization', 'multipleWords': False}, {'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'repository', 'multipleWords': False}], 'schema': 'http://schemas.taskcluster.net/github/v1/github-push-message.json#', 'name': 'push', 'exchange': 'push'}, *args, **kwargs)
    ...
    def release(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'organization', 'multipleWords': False}, {'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'required': True, 'name': 'repository', 'multipleWords': False}], 'schema': 'http://schemas.taskcluster.net/github/v1/github-release-message.json#', 'name': 'release', 'exchange': 'release'}, *args, **kwargs)
