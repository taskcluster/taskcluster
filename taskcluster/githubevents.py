...
class GithubEvents(BaseClient):
    ...
    def pullRequest(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': 'http://schemas.taskcluster.net/github/v1/github-pull-request-message.json#', 'routingKey': [{'multipleWords': False, 'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'name': 'routingKeyKind', 'constant': 'primary', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'organization', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'repository', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `action` which triggered an event. See for possible values see the payload actions property.', 'name': 'action', 'required': True}], 'exchange': 'pull-request', 'name': 'pullRequest'}, *args, **kwargs)
    ...
    def push(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': 'http://schemas.taskcluster.net/github/v1/github-push-message.json#', 'routingKey': [{'multipleWords': False, 'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'name': 'routingKeyKind', 'constant': 'primary', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'organization', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'repository', 'required': True}], 'exchange': 'push', 'name': 'push'}, *args, **kwargs)
    ...
    def release(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': 'http://schemas.taskcluster.net/github/v1/github-release-message.json#', 'routingKey': [{'multipleWords': False, 'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'name': 'routingKeyKind', 'constant': 'primary', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'organization', 'required': True}, {'multipleWords': False, 'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'repository', 'required': True}], 'exchange': 'release', 'name': 'release'}, *args, **kwargs)
