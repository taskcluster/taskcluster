...
class Index(BaseClient):
    ...
    **Remark**, when indexing tasks using custom routes, it's also possible
    ...
    def listNamespacesPost(self, *args, **kwargs):
        """
        List Namespaces
        ...
        return self._makeApiCall(self.funcinfo["listNamespacesPost"], *args, **kwargs)
    ...
    def listTasksPost(self, *args, **kwargs):
        """
        List Tasks
        ...
        **Remark**, this end-point is designed for humans browsing for tasks, not
        ...
        return self._makeApiCall(self.funcinfo["listTasksPost"], *args, **kwargs)
