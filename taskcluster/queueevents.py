...
class QueueEvents(BaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'multipleWords': False, 'required': True, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'multipleWords': False, 'required': True, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'multipleWords': False, 'required': True, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'multipleWords': False, 'required': True, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'multipleWords': False, 'required': True, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'multipleWords': False, 'required': True, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'multipleWords': False, 'required': True, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'multipleWords': True, 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'artifactCreated', 'exchange': 'artifact-created', 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'multipleWords': False, 'required': True, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'multipleWords': False, 'required': True, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'multipleWords': False, 'required': True, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'multipleWords': False, 'required': True, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'multipleWords': False, 'required': True, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'multipleWords': False, 'required': True, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'multipleWords': False, 'required': True, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'multipleWords': True, 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskCompleted', 'exchange': 'task-completed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'multipleWords': False, 'required': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'multipleWords': False, 'required': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'multipleWords': False, 'required': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'multipleWords': False, 'required': True, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'multipleWords': False, 'required': True, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'multipleWords': False, 'required': True, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'multipleWords': False, 'required': True, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'multipleWords': True, 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskFailed', 'exchange': 'task-failed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#'}, *args, **kwargs)
    ...
    def taskException(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'multipleWords': False, 'required': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'multipleWords': False, 'required': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'multipleWords': False, 'required': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'multipleWords': False, 'required': True, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'multipleWords': False, 'required': True, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'multipleWords': False, 'required': True, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'multipleWords': False, 'required': True, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'multipleWords': True, 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskException', 'exchange': 'task-exception', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-exception-message.json#'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': '`taskGroupId` for the task-group this message concerns', 'name': 'taskGroupId'}, {'multipleWords': False, 'required': True, 'summary': '`schedulerId` for the task-group this message concerns', 'name': 'schedulerId'}, {'multipleWords': True, 'required': False, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGroupResolved', 'exchange': 'task-group-resolved', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#'}, *args, **kwargs)
