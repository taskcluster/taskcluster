...
class QueueEvents(BaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'artifact-created', 'name': 'artifactCreated', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': True, 'name': 'taskId', 'summary': '`taskId` for the task this message concerns', 'multipleWords': False}, {'required': True, 'name': 'runId', 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'workerGroup', 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'workerId', 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'provisionerId', 'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False}, {'required': True, 'name': 'workerType', 'summary': '`workerType` this task must run on.', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': '`schedulerId` this task was created by.', 'multipleWords': False}, {'required': True, 'name': 'taskGroupId', 'summary': '`taskGroupId` this task was created in.', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-completed', 'name': 'taskCompleted', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': True, 'name': 'taskId', 'summary': '`taskId` for the task this message concerns', 'multipleWords': False}, {'required': True, 'name': 'runId', 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'workerGroup', 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'workerId', 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'provisionerId', 'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False}, {'required': True, 'name': 'workerType', 'summary': '`workerType` this task must run on.', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': '`schedulerId` this task was created by.', 'multipleWords': False}, {'required': True, 'name': 'taskGroupId', 'summary': '`taskGroupId` this task was created in.', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-failed', 'name': 'taskFailed', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': True, 'name': 'taskId', 'summary': '`taskId` for the task this message concerns', 'multipleWords': False}, {'required': False, 'name': 'runId', 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': False, 'name': 'workerGroup', 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': False, 'name': 'workerId', 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False}, {'required': True, 'name': 'provisionerId', 'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False}, {'required': True, 'name': 'workerType', 'summary': '`workerType` this task must run on.', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': '`schedulerId` this task was created by.', 'multipleWords': False}, {'required': True, 'name': 'taskGroupId', 'summary': '`taskGroupId` this task was created in.', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-group-resolved', 'name': 'taskGroupResolved', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': True, 'name': 'taskGroupId', 'summary': '`taskGroupId` for the task-group this message concerns', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': '`schedulerId` for the task-group this message concerns', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#'}, *args, **kwargs)
