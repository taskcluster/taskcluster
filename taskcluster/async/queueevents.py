...
class QueueEvents(AsyncBaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def taskDefined(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskDefined', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-defined-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-defined'}, *args, **kwargs)
    ...
    def taskPending(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskPending', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-pending-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': True}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-pending'}, *args, **kwargs)
    ...
    def taskRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskRunning', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-running-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': True}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': True}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': True}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-running'}, *args, **kwargs)
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'artifactCreated', 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': True}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': True}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': True}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'artifact-created'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskCompleted', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': True}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': True}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': True}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-completed'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskFailed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-failed'}, *args, **kwargs)
    ...
    def taskException(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskException', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-exception-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'multipleWords': False, 'required': True}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'multipleWords': False, 'required': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'multipleWords': False, 'required': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'multipleWords': False, 'required': False}, {'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'multipleWords': False, 'required': True}, {'summary': '`workerType` this task must run on.', 'name': 'workerType', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-exception'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'name': 'taskGroupResolved', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'multipleWords': False, 'constant': 'primary', 'required': True}, {'summary': '`taskGroupId` for the task-group this message concerns', 'name': 'taskGroupId', 'multipleWords': False, 'required': True}, {'summary': '`schedulerId` for the task-group this message concerns', 'name': 'schedulerId', 'multipleWords': False, 'required': True}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'multipleWords': True, 'required': False}], 'exchange': 'task-group-resolved'}, *args, **kwargs)
