...
class QueueEvents(AsyncBaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def taskDefined(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskDefined', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-defined-message.json#', 'exchange': 'task-defined'}, *args, **kwargs)
    ...
    def taskPending(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': True, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskPending', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-pending-message.json#', 'exchange': 'task-pending'}, *args, **kwargs)
    ...
    def taskRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': True, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': True, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': True, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskRunning', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-running-message.json#', 'exchange': 'task-running'}, *args, **kwargs)
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': True, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': True, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': True, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'artifactCreated', 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#', 'exchange': 'artifact-created'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': True, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': True, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': True, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskCompleted', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#', 'exchange': 'task-completed'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskFailed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#', 'exchange': 'task-failed'}, *args, **kwargs)
    ...
    def taskException(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId'}, {'required': True, 'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId'}, {'required': True, 'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskException', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-exception-message.json#', 'exchange': 'task-exception'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': '`taskGroupId` for the task-group this message concerns', 'name': 'taskGroupId'}, {'required': True, 'multipleWords': False, 'summary': '`schedulerId` for the task-group this message concerns', 'name': 'schedulerId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGroupResolved', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#', 'exchange': 'task-group-resolved'}, *args, **kwargs)
