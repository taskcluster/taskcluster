...
class QueueEvents(AsyncBaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def taskDefined(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-defined-message.json#', 'name': 'taskDefined', 'exchange': 'task-defined'}, *args, **kwargs)
    ...
    def taskPending(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-pending-message.json#', 'name': 'taskPending', 'exchange': 'task-pending'}, *args, **kwargs)
    ...
    def taskRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-running-message.json#', 'name': 'taskRunning', 'exchange': 'task-running'}, *args, **kwargs)
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#', 'name': 'artifactCreated', 'exchange': 'artifact-created'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': True, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#', 'name': 'taskCompleted', 'exchange': 'task-completed'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#', 'name': 'taskFailed', 'exchange': 'task-failed'}, *args, **kwargs)
    ...
    def taskException(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'required': True, 'name': 'taskId', 'multipleWords': False}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': '`provisionerId` this task is targeted at.', 'required': True, 'name': 'provisionerId', 'multipleWords': False}, {'summary': '`workerType` this task must run on.', 'required': True, 'name': 'workerType', 'multipleWords': False}, {'summary': '`schedulerId` this task was created by.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': '`taskGroupId` this task was created in.', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-exception-message.json#', 'name': 'taskException', 'exchange': 'task-exception'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskGroupId` for the task-group this message concerns', 'required': True, 'name': 'taskGroupId', 'multipleWords': False}, {'summary': '`schedulerId` for the task-group this message concerns', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#', 'name': 'taskGroupResolved', 'exchange': 'task-group-resolved'}, *args, **kwargs)
