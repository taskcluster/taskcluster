...
class QueueEvents(AsyncBaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def taskDefined(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-defined', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-defined-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskDefined'}, *args, **kwargs)
    ...
    def taskPending(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-pending', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-pending-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskPending'}, *args, **kwargs)
    ...
    def taskRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-running', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-running-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskRunning'}, *args, **kwargs)
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'artifact-created', 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'artifactCreated'}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-completed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': True, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskCompleted'}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-failed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskFailed'}, *args, **kwargs)
    ...
    def taskException(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-exception', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-exception-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskId` for the task this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskId'}, {'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': '`provisionerId` this task is targeted at.', 'multipleWords': False, 'required': True, 'name': 'provisionerId'}, {'summary': '`workerType` this task must run on.', 'multipleWords': False, 'required': True, 'name': 'workerType'}, {'summary': '`schedulerId` this task was created by.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': '`taskGroupId` this task was created in.', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskException'}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-group-resolved', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': '`taskGroupId` for the task-group this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskGroupId'}, {'summary': '`schedulerId` for the task-group this message concerns', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskGroupResolved'}, *args, **kwargs)
