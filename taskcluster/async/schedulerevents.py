...
class SchedulerEvents(AsyncBaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-running', 'name': 'taskGraphRunning', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': False, 'name': 'taskId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'runId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerGroup', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'provisionerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerType', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False}, {'required': True, 'name': 'taskGraphId', 'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-running-message.json#'}, *args, **kwargs)
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-extended', 'name': 'taskGraphExtended', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': False, 'name': 'taskId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'runId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerGroup', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'provisionerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerType', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False}, {'required': True, 'name': 'taskGraphId', 'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-blocked', 'name': 'taskGraphBlocked', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': False, 'name': 'taskId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'runId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerGroup', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'provisionerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerType', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False}, {'required': True, 'name': 'taskGraphId', 'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-finished', 'name': 'taskGraphFinished', 'routingKey': [{'required': True, 'name': 'routingKeyKind', 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'multipleWords': False}, {'required': False, 'name': 'taskId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'runId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerGroup', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'provisionerId', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': False, 'name': 'workerType', 'summary': 'Always takes the value `_`', 'multipleWords': False}, {'required': True, 'name': 'schedulerId', 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False}, {'required': True, 'name': 'taskGraphId', 'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False}, {'required': False, 'name': 'reserved', 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#'}, *args, **kwargs)
