...
class SchedulerEvents(AsyncBaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'taskId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'provisionerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerType', 'multipleWords': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': 'Identifier for the task-graph this message concerns', 'required': True, 'name': 'taskGraphId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-running-message.json#', 'name': 'taskGraphRunning', 'exchange': 'task-graph-running'}, *args, **kwargs)
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'taskId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'provisionerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerType', 'multipleWords': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': 'Identifier for the task-graph this message concerns', 'required': True, 'name': 'taskGraphId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#', 'name': 'taskGraphExtended', 'exchange': 'task-graph-extended'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'taskId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'provisionerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerType', 'multipleWords': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': 'Identifier for the task-graph this message concerns', 'required': True, 'name': 'taskGraphId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#', 'name': 'taskGraphBlocked', 'exchange': 'task-graph-blocked'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'required': True, 'multipleWords': False, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'taskId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'runId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerGroup', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'provisionerId', 'multipleWords': False}, {'summary': 'Always takes the value `_`', 'required': False, 'name': 'workerType', 'multipleWords': False}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'required': True, 'name': 'schedulerId', 'multipleWords': False}, {'summary': 'Identifier for the task-graph this message concerns', 'required': True, 'name': 'taskGraphId', 'multipleWords': False}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'required': False, 'name': 'reserved', 'multipleWords': True}], 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#', 'name': 'taskGraphFinished', 'exchange': 'task-graph-finished'}, *args, **kwargs)
