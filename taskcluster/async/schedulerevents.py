...
class SchedulerEvents(AsyncBaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'provisionerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGraphRunning', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-running-message.json#', 'exchange': 'task-graph-running'}, *args, **kwargs)
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'provisionerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGraphExtended', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#', 'exchange': 'task-graph-extended'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'provisionerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGraphBlocked', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#', 'exchange': 'task-graph-blocked'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'taskId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'runId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerGroup'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'provisionerId'}, {'required': False, 'multipleWords': False, 'summary': 'Always takes the value `_`', 'name': 'workerType'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'name': 'schedulerId'}, {'required': True, 'multipleWords': False, 'summary': 'Identifier for the task-graph this message concerns', 'name': 'taskGraphId'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'taskGraphFinished', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#', 'exchange': 'task-graph-finished'}, *args, **kwargs)
