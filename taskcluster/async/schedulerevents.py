...
class SchedulerEvents(AsyncBaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-running', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-running-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'taskId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'provisionerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerType'}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskGraphId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskGraphRunning'}, *args, **kwargs)
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-extended', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'taskId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'provisionerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerType'}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskGraphId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskGraphExtended'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-blocked', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'taskId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'provisionerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerType'}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskGraphId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskGraphBlocked'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-graph-finished', 'schema': 'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#', 'routingKey': [{'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'multipleWords': False, 'required': True, 'name': 'routingKeyKind', 'constant': 'primary'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'taskId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'runId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerGroup'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'provisionerId'}, {'summary': 'Always takes the value `_`', 'multipleWords': False, 'required': False, 'name': 'workerType'}, {'summary': 'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.', 'multipleWords': False, 'required': True, 'name': 'schedulerId'}, {'summary': 'Identifier for the task-graph this message concerns', 'multipleWords': False, 'required': True, 'name': 'taskGraphId'}, {'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'multipleWords': True, 'required': False, 'name': 'reserved'}], 'name': 'taskGraphFinished'}, *args, **kwargs)
