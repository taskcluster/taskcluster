...
class AwsProvisionerEvents(AsyncBaseClient):
    ...
    def workerTypeUpdated(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': 'WorkerType that this message concerns.', 'name': 'workerType'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'workerTypeUpdated', 'schema': 'http://schemas.taskcluster.net/aws-provisioner/v1/worker-type-message.json#', 'exchange': 'worker-type-updated'}, *args, **kwargs)
    ...
    def workerTypeRemoved(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'required': True, 'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'name': 'routingKeyKind', 'constant': 'primary'}, {'required': True, 'multipleWords': False, 'summary': 'WorkerType that this message concerns.', 'name': 'workerType'}, {'required': False, 'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved'}], 'name': 'workerTypeRemoved', 'schema': 'http://schemas.taskcluster.net/aws-provisioner/v1/worker-type-message.json#', 'exchange': 'worker-type-removed'}, *args, **kwargs)
