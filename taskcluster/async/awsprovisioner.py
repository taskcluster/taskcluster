...
class AwsProvisioner(AsyncBaseClient):
    ...
    async def createAmiSet(self, *args, **kwargs):
        """
        Create new AMI Set
        ...
        return await self._makeApiCall(self.funcinfo["createAmiSet"], *args, **kwargs)

    async def amiSet(self, *args, **kwargs):
        """
        Get AMI Set
        ...
        return await self._makeApiCall(self.funcinfo["amiSet"], *args, **kwargs)

    async def updateAmiSet(self, *args, **kwargs):
        """
        Update AMI Set
        ...
        return await self._makeApiCall(self.funcinfo["updateAmiSet"], *args, **kwargs)

    async def listAmiSets(self, *args, **kwargs):
        """
        List AMI sets
        ...
        return await self._makeApiCall(self.funcinfo["listAmiSets"], *args, **kwargs)

    async def removeAmiSet(self, *args, **kwargs):
        """
        Delete AMI Set
        ...
        return await self._makeApiCall(self.funcinfo["removeAmiSet"], *args, **kwargs)
