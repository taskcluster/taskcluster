...
class GithubEvents(AsyncBaseClient):
    ...
    def push(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'organization'}, {'multipleWords': False, 'required': True, 'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'repository'}], 'name': 'push', 'exchange': 'push', 'schema': 'http://schemas.taskcluster.net/github/v1/github-push-message.json#'}, *args, **kwargs)
    ...
    def release(self, *args, **kwargs):
        return self._makeTopicExchange({'routingKey': [{'constant': 'primary', 'multipleWords': False, 'required': True, 'summary': 'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.', 'name': 'routingKeyKind'}, {'multipleWords': False, 'required': True, 'summary': 'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'organization'}, {'multipleWords': False, 'required': True, 'summary': 'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.', 'name': 'repository'}], 'name': 'release', 'exchange': 'release', 'schema': 'http://schemas.taskcluster.net/github/v1/github-release-message.json#'}, *args, **kwargs)
