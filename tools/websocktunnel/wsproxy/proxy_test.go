...
import (
	...
	"github.com/taskcluster/taskcluster/v106/tools/websocktunnel/client"
	"github.com/taskcluster/taskcluster/v106/tools/websocktunnel/util"
	"github.com/taskcluster/taskcluster/v106/tools/websocktunnel/wsmux"
)
...
func TestClientURL(t *testing.T) {
	...
	for _, prefix := range prefixes {
		...
		if client.URL() != strings.TrimSuffix(prefix, "/")+"/myclient" {
