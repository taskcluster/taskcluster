...
import (
	...
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/aws"
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/azure"
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/google"
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/provider"
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/standalone"
	"github.com/taskcluster/taskcluster/v28/tools/taskcluster-worker-runner/provider/static"
)
