...
The `github.com/taskcluster/taskcluster/v86/tools/workerproto` package contains an implementation of this protocol suitable for use by `start-worker` and by a worker.
