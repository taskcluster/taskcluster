...
The `github.com/taskcluster/taskcluster/v28/tools/worker-runner/protocol` package contains an implementation of this protocol suitable for use by `start-worker` and by a worker.
