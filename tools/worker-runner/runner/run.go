...
import (
	...
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/errorreport"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/exit"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/files"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/logging"
	loggingProtocol "github.com/taskcluster/taskcluster/v46/tools/worker-runner/logging/protocol"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/provider"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/registration"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/run"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/secrets"
	"github.com/taskcluster/taskcluster/v46/tools/worker-runner/worker"
