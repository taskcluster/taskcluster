...
import (
	...
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/aws"
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/azure"
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/google"
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/provider"
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/standalone"
	"github.com/taskcluster/taskcluster/v81/tools/worker-runner/provider/static"
)
