...
import (
	...
	d2g "github.com/taskcluster/taskcluster/v56/tools/d2g"
	"github.com/taskcluster/taskcluster/v56/tools/d2g/dockerworker"
	"github.com/taskcluster/taskcluster/v56/tools/d2g/genericworker"
)
...
func (tc *TestCase) TestTaskPayload(t *testing.T) {
	t.Helper()
