...
const ListNamespaces = lazy(() => import(/* webpackChunkName: 'TaskIndex.ListNamespaces' */ './ListNamespaces'));
const IndexedTask = lazy(() => import(/* webpackChunkName: 'TaskIndex.IndexedTask' */ './IndexedTask'));
const IndexedTaskTaskGroupRedirect = lazy(
  () => import(/* webpackChunkName: 'TaskIndex.IndexedTaskTaskGroupRedirect' */ './IndexedTask/taskGroupRedirect'),
);
