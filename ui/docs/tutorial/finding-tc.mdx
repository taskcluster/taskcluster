...
The Firefox CI deployment is publicly viewable, and you are welcome to explore it; its root URL is [https://firefox-ci-tc.services.mozilla.com/](https://firefox-ci-tc.services.mozilla.com/).
