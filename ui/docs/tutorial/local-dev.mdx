...
It will need some time to intialize database and start the services, after which everything should be accessible at [http://localhost](http://localhost)
...
Which will allow you to open [http://taskcluster](http://taskcluster) in browser.
...
UI should redirect you to the newly created task page, i.e. [http://taskcluster/tasks/QiGSm7nTTkOVZKLYBPKjMA](http://taskcluster/tasks/QiGSm7nTTkOVZKLYBPKjMA).
