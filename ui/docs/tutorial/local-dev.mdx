...
* `docker-compose` will have a single worker type called `generic-worker`. This is a [simple generic worker](/docs/reference/workers/generic-worker) that can run real commands.
