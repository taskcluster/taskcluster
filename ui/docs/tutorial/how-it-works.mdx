...
In many cases, worker pools use cloud services to [dymamically create and destroy workers](/docs/manual/task-execution/provisioning) as demand fluctuates, but Taskcluster also supports static, always-on workers.
