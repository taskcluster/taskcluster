...
To disable all tasks, please make sure that pull request has `[ci skip]` in its title also. Once everything is ready, you can remove this from the title to allow Taskcluster to create tasks again.
