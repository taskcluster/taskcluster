...
<ReferenceLinks api exchanges logs metrics />
...
To add the App for this deployment of Taskcluster to a GitHub repository or organization, add <SiteLink name="github_app_url">this GitHub App</SiteLink>.
</SiteSpecific>
