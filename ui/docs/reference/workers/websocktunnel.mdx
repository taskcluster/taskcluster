...
It is implemented by the [`tools/websocktunnel/wsmux`](https://godoc.org/github.com/taskcluster/taskcluster/tools/websocktunnel/wsmux) package.
The [`tools/websocktunnel/client`](https://godoc.org/github.com/taskcluster/taskcluster/tools/websocktunnel/client) package uses this to implement the client side of the connection.
...
See Documentation at [godoc.org](https://godoc.org/github.com/taskcluster/taskcluster/tools/websocktunnel).
