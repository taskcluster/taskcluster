...
It is implemented by the [`tools/websocktunnel/wsmux`](https://pkg.go.dev/github.com/taskcluster/taskcluster/v56/tools/websocktunnel/wsmux) package.
The [`tools/websocktunnel/client`](https://pkg.go.dev/github.com/taskcluster/taskcluster/v56/tools/websocktunnel/client) package uses this to implement the client side of the connection.

The latter package exposes a [`Client`](https://pkg.go.dev/github.com/taskcluster/taskcluster/v56/tools/websocktunnel/client#Client) struct which implements `net.Listener`.
...
See Documentation at [pkg.go.dev](https://pkg.go.dev/github.com/taskcluster/taskcluster/v56/tools/websocktunnel).
