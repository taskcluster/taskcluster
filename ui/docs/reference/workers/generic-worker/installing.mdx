...
11. Create `/etc/generic-worker/config` with appropriate configuration settings
    ...
    ```
    {
     ...
     "workerLocation": "{\"cloud\":\"standalone\",\"host\":\"macstadium\"}",
     "workerType": "gecko-t-osx-1400-m2-staging",
     "workerTypeMetadata": {},
     "wstAudience": "firefoxcitc",
     "wstServerURL": "https://firefoxci-websocktunnel.services.mozilla.com/"
  }
    ```
12. Create `/etc/generic-worker/runner.yml` with appropriate configuration settings. Something like this:
