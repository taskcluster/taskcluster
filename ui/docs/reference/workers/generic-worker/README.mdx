...
Depending on the operating system of the worker, and the generic-worker engine that has been installed (multiuser or simple), the exact form of the required payload varies.
