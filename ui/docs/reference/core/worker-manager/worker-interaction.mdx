...
The worker may reregister itself to renew its credentials with the worker manager by calling [`worker.reregister`](/docs/reference/core/worker-manager/api#reregisterWorker)
