...
A list of the database versions with brief descriptions can be found in [the source code](https://github.com/taskcluster/taskcluster/tree/master/db/versions).
