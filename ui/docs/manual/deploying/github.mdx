...
This is a multi-line string, and unfortunately Kubernetes does not support multiline secrets - it replaces newlines with the escape sequence `\n`.
The service can accept this form as well, e.g.,  `-----BEGIN RSA PRIVATE KEY-----\n{key material}\n-----END RSA PRIVATE KEY-----`.
