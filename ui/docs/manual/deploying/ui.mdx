...
ui:
  site_specific:
    ...
    # default payload schema for the documentation tutorial; see
    # ui/src/utils/constants.js for valid keys (e.g. generic-multi-posix).
    # Defaults to generic-multi-posix if unset.
