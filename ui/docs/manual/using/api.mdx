...
* Shell - https://github.com/taskcluster/taskcluster/tree/master/clients/client-shell
...
The [shell client](https://github.com/taskcluster/taskcluster/tree/master/clients/client-shell) provides an easy way to set the necessary environment variables:
