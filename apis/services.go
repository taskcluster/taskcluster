...
var schemas = map[string]string{
	...
	"http://schemas.taskcluster.net/github/v1/is-installed-for.json":                               "{\n    \"$schema\": \"http://json-schema.org/draft-04/schema#\",\n    \"title\": \"isInstalledFor\",\n    \"description\": \"Check if Repository has Integration\\n\",\n    \"type\": \"object\",\n    \"properties\": {\n        \"installed\": {\n            \"type\": \"boolean\",\n            \"description\": \"True if integration is installed, False otherwise.\\n\"\n        }\n    },\n    \"additionalProperties\": false,\n    \"required\": [\n        \"installed\"\n    ],\n    \"id\": \"http://schemas.taskcluster.net/github/v1/is-installed-for.json#\"\n}",
