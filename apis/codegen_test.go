...
func TestCodeGeneration(t *testing.T) {
	...
	desired := getDesiredOutput("services_test.go")
...
// getDesiredOutput simply returns the code that should be generated
func getDesiredOutput(filename string) (string) {
	return `package apis
