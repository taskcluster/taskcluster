...
# install go
md "C:\gopath"
Expand-ZIPFile -File "C:\go1.11.5.windows-386.zip" -Destination "C:\" -Url "https://storage.googleapis.com/golang/go1.11.5.windows-386.zip"
...
[Environment]::SetEnvironmentVariable("PATH", $Env:Path + ";C:\Program Files\Vim\vim80;C:\go\bin;C:\gopath\bin;C:\mozilla-build\python;C:\mozilla-build\python\Scripts;C:\Program Files (x86)\Git\cmd;C:\Program Files\nodejs", "Machine")
...
# build generic-worker and livelog source code
md C:\generic-worker
...
# install livelog
Copy-Item C:\gopath\bin\livelog.exe C:\generic-worker
...
$client.DownloadFile("https://raw.githubusercontent.com/petemoore/myscrapbook/master/run-generic-worker.bat", "C:\generic-worker\run-generic-worker.bat")
