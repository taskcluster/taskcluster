...
# to build the AMIs for aws-provisioner-v1/gecko-t-win7-32-gpu-b.
#
# The authoratative host definition can be found at:
#
#   * https://raw.githubusercontent.com/mozilla-releng/OpenCloudConfig/master/userdata/Manifest/gecko-t-win7-32-gpu-b.json
#
###################################################################################
...
$client.DownloadFile("https://raw.githubusercontent.com/mozilla-releng/OpenCloudConfig/master/userdata/Configuration/fluentd/generic-worker.conf", "C:\Program Files\Stackdriver\LoggingAgent\config.d\generic-worker.conf")

# fluentd_genericworkerservice: Maintenance Toolchain - not essential for building firefox
$client.DownloadFile("https://raw.githubusercontent.com/mozilla-releng/OpenCloudConfig/master/userdata/Configuration/fluentd/generic-worker-service.conf", "C:\Program Files\Stackdriver\LoggingAgent\config.d\generic-worker-service.conf")

# fluentd_genericworkerwrapper: Maintenance Toolchain - not essential for building firefox
$client.DownloadFile("https://raw.githubusercontent.com/mozilla-releng/OpenCloudConfig/master/userdata/Configuration/fluentd/generic-worker-wrapper.conf", "C:\Program Files\Stackdriver\LoggingAgent\config.d\generic-worker-wrapper.conf")
...
$client.DownloadFile("https://github.com/taskcluster/generic-worker/releases/download/v16.3.0/generic-worker-multiuser-windows-386.exe", "C:\generic-worker\generic-worker.exe")
