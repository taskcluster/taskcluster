...
$client.DownloadFile("https://github.com/taskcluster/generic-worker/releases/download/v16.4.0/generic-worker-multiuser-windows-386.exe", "C:\generic-worker\generic-worker.exe")
