...
func (binding WorkerTypeCreated) ExchangeName() string {
	return "exchange/taskcluster-aws-provisioner-staging/v1/worker-type-created"
}
...
func (binding WorkerTypeUpdated) ExchangeName() string {
	return "exchange/taskcluster-aws-provisioner-staging/v1/worker-type-updated"
}
...
func (binding WorkerTypeRemoved) ExchangeName() string {
	return "exchange/taskcluster-aws-provisioner-staging/v1/worker-type-removed"
}
